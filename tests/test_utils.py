...
# Создаем Mock объект
mock_response = Mock()
# Настраиваем метод .json() возвращать список словарей
mock_response.json.return_value = [{"key": "value"}]

# Теперь, когда mock_response.json() будет вызван, он вернет [{"key": "value"}]
...
class TestReadJson(unittest.TestCase):
    ...
    def test_file_not_found_error(self, mocked_open):
